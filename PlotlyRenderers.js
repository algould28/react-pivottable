  ...
  var Renderer = (function(_React$PureComponent) {
    ...
    function Renderer() {
      ...
      return _possibleConstructorReturn(
        this,
        (Renderer.__proto__ || Object.getPrototypeOf(Renderer)).apply(
          this,
          arguments
        )
      );
    ...
    _createClass(Renderer, [
      {
        ...
        value: function render() {
          ...
          if (numInputs !== 0) {
            fullAggName +=
              ' of ' + this.props.vals.slice(0, numInputs).join(', ');
          }
          ...
          var data = traceKeys.map(function(traceKey) {
            ...
            try {
              for (
                var _iterator = datumKeys[Symbol.iterator](), _step;
          ...
          var hAxisTitle = transpose
            ? this.props.rows.join('-')
            : this.props.cols.join('-');
          var groupByTitle = transpose
            ? this.props.cols.join('-')
            : this.props.rows.join('-');
          if (hAxisTitle !== '') {
    ...
    _createClass(Renderer, [
      {
        ...
        value: function render() {
          ...
          var layout = {
            title:
              this.props.rows.join('-') + ' vs ' + this.props.cols.join('-'),
            hovermode: 'closest',
            /* eslint-disable no-magic-numbers */
